...
public class Manage {
    ...
    public String postIndex(HttpServletRequest request) {
        ...
        Application.getJdbcTemplate().update("update system set value=? where entity='sys' and attribute='beian'", map.get("beian"));
        Application.getJdbcTemplate().update("update system set value=? where entity='sys' and attribute='jsPath'", map.get("jsPath"));
        Application.getJdbcTemplate().update("update system set value=? where entity='sys' and attribute='keywords'", map.get("keywords"));
        Application.getJdbcTemplate().update("update system set value=? where entity='sys' and attribute='maxBuyNum'", map.get("maxBuyNum"));
        Application.getJdbcTemplate().update("update system set value=? where entity='sys' and attribute='name'", map.get("siteName"));
        Application.getJdbcTemplate().update("update system set value=? where entity='sys' and attribute='url'", map.get("siteUrl"));
        Application.getJdbcTemplate().update("update system set value=? where entity='storage' and attribute='type'", map.get("storageType"));
        Application.getJdbcTemplate().update("update system set value=? where entity='storage' and attribute='ossAk'", Crypto.encrypt(map.get("ossAk")));
        Application.getJdbcTemplate().update("update system set value=? where entity='storage' and attribute='ossAks'", Crypto.encrypt(map.get("ossAks")));
        Application.getJdbcTemplate().update("update system set value=? where entity='storage' and attribute='ossBucket'", map.get("ossBucket"));
        Application.getJdbcTemplate().update("update system set value=? where entity='storage' and attribute='ossBucketUrl'", map.get("ossBucketUrl"));
        Application.getJdbcTemplate().update("update system set value=? where entity='storage' and attribute='ossEndpoint'", map.get("ossEndpoint"));
        Application.getJdbcTemplate().update("update system set value=? where entity='theme' and attribute='mobile'", map.get("themeMobile"));
        Application.getJdbcTemplate().update("update system set value=? where entity='theme' and attribute='pc'", map.get("themePc"));
        SystemCache.init();
