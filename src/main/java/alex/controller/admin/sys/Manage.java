...
public class Manage {
    ...
    public String postIndex(HttpServletRequest request) {
        ...
        Application.JDBC_TEMPLATE.update("update system set value=? where entity='storage' and attribute='ossAk'", Crypto.encrypt(map.get("ossAk")));
        Application.JDBC_TEMPLATE.update("update system set value=? where entity='storage' and attribute='ossAks'", Crypto.encrypt(map.get("ossAks")));
        Application.JDBC_TEMPLATE.update("update system set value=? where entity='storage' and attribute='ossBucket'", map.get("ossBucket"));
        Application.JDBC_TEMPLATE.update("update system set value=? where entity='storage' and attribute='ossBucketUrl'", map.get("ossBucketUrl"));
        Application.JDBC_TEMPLATE.update("update system set value=? where entity='storage' and attribute='ossEndpoint'", map.get("ossEndpoint"));
